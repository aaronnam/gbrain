...
| Trigger | Skill |
|---------|-------|
| "What do we know about", "tell me about", "search for", "who is", "background on", "notes on", "do we already have notes on", "notes on this person" | `skills/query/SKILL.md` |
...
| "Fix broken citations", "fix broken citations in brain pages", "citation audit", "check citations", "fix citations" | `skills/citation-fixer/SKILL.md` (focused fix). For broader brain health, chain into `skills/maintain/SKILL.md` |
